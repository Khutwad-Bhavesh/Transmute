...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final _engines = [
    {'title': 'Lightweight', 'sub': 'Dart-only libs. No setup needed.', 'size': '~50MB install', 'icon': '⚡'},
    {'title': 'Powerful', 'sub': 'Bundles ffmpeg + tools automatically.', 'size': '~200MB install', 'icon': '🔧'},
    {'title': 'Manual', 'sub': "I'll install tools myself.", 'size': 'Smallest install', 'icon': '🎛️'},
  ];
      ...
      body: Center(
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              Text('FileConverter', style: AppTypography.label.copyWith(color: AppColors.teal, letterSpacing: 0.1)),
